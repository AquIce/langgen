...
std::shared_ptr<langgen::ast::Expression> tlang::ast::AssignationExpression::get_value() {
	return this->value;
}
...
tlang::ast::DeclarationExpression::DeclarationExpression(std::shared_ptr<Identifier> identifier, std::shared_ptr<langgen::ast::Expression> value, std::string value_type, bool isMutable)
...
std::shared_ptr<langgen::ast::Expression> tlang::ast::UnaryExpression::get_term() {
	return this->term;
}
...
std::shared_ptr<langgen::ast::Expression> tlang::ast::BinaryExpression::get_left() {
	return this->left;
}
std::string tlang::ast::BinaryExpression::get_operator_symbol() {
	return this->operator_symbol;
}
std::shared_ptr<langgen::ast::Expression> tlang::ast::BinaryExpression::get_right() {
	return this->right;
}
