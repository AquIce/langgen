...
// 	while(peek(src) == ENT__DECIMAL_SEPARATOR || isdigit(peek(src))) {
// 		if(peek(src) == ENT__DECIMAL_SEPARATOR) {
// 			if(!is_integer) {
...
// 	std::string buffer = "";
// 	while(peek(src) != ENT__STRING_DELIMITER) {
...
// 	if(isdigit(peek(src)) || peek(src) == ENT__DECIMAL_SEPARATOR) {
...
// 	if(peek(src) == ENT__CHAR_DELIMITER) {
// 		(void)shift(src);
...
// 	if(peek(src) == ENT__STRING_DELIMITER) {
// 		(void)shift(src);
...
// 	while(isalpha(peek(src)) || peek(src) == '_') {
